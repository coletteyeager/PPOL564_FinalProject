...
![Missing Data](/Users/coletteyeager/Desktop/Code/PPOL564_FinalProject/Data/Figures/Missing_Data.png)
...
![Election Results](/Users/coletteyeager/Desktop/Code/PPOL564_FinalProject/Data/Figures/election_results.png){height=40%}
...
```{r, echo=FALSE,out.width="60%", out.height="40%",fig.cap="Overall and Accurate Swing States",fig.show='hold',fig.align='center'}
knitr::include_graphics(c("/Users/coletteyeager/Desktop/Code/PPOL564_FinalProject/Data/Figures/Overall_Swing.png","/Users/coletteyeager/Desktop/Code/PPOL564_FinalProject/Data/Figures/Accurate_Swing.png"))
``` 
...
![GDP by Vote Share](/Users/coletteyeager/Desktop/Code/PPOL564_FinalProject/Data/Figures/gdp_by_share.png)

![Turnout Rate by Vote Share](/Users/coletteyeager/Desktop/Code/PPOL564_FinalProject/Data/Figures/turnout_by_share.png)

It did look like there were some slight trends from these graphs, with Figure (2?) having a negative correlation and Figure (3?) having a positive correlation. I also took a look at some of the interactions with the dummy variables, such as how political party and incumbent status interact with the relationship between change in GDP and vote share as seen below in Figures (4?) and (5?). 

![GDP by Vote Share by Party](/Users/coletteyeager/Desktop/Code/PPOL564_FinalProject/Data/Figures/gdp_party_share.png)
...
When I ran each of my models using the different subsets I created, I found that there were pretty different levels of accuracy depending on the subset. 
* Discuss relative scores for each model and how the swing states compared
...
![Variable Importance](/Users/coletteyeager/Desktop/Code/PPOL564_FinalProject/Data/Figures/variable_importance.png)
![Variable Importance](/Users/coletteyeager/Desktop/Code/PPOL564_FinalProject/Data/Figures/Feature_dependence.png)

![Variable Importance](/Users/coletteyeager/Desktop/Code/PPOL564_FinalProject/Data/Figures/ice_plot.png)

Found that change in gdp, turnout rate, and incumbent were most important, which made sense with previous studies and was pretty cool
Looking at the distribution of partial dependence of variables was interesting, had some very non-linear changes
